...
class WC_Local_Pickup_Plus_Integration_Mix_And_Match_Products {
	...
	private function is_shipping_handled_by_parent_container( $cart_item ) {
		...
		return $product_container && $product_container->is_type( 'mix-and-match' ) && 'yes' !== SV_WC_Product_Compatibility::get_meta( $product_container, '_mnm_per_product_shipping', true, 'view' );
	}
