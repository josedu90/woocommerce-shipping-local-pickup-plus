...
class WC_Local_Pickup_Plus_Pickup_Location {
	...
	/**
	 * Get the price adjustment for this location.
	 *
	 * @since 2.0.0
	 *
	 * @return null|\WC_Local_Pickup_Plus_Price_Adjustment
	 */
	public function get_price_adjustment() {
		...
		if ( empty( $price_adjustment_meta ) ) {
		...
		/**
		 * Filter the price adjustment for the pickup location.
		 *
		 * @since 2.0.0
		 *
