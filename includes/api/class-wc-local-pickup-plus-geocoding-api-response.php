 ...
 * @since 2.0.0
 */
class WC_Local_Pickup_Plus_Geocoding_API_Response extends SV_WC_API_JSON_Response {
	 ...
	 * @throws \SV_WC_Plugin_Exception An exception if an error occurred and coordinates weren't retrieved
	 */
	public function get_coordinates() {
		...
		if ( ! $success && isset( $this->response_data->response_data->error_message ) ) {
			throw new SV_WC_Plugin_Exception( $this->response_data->response_data->error_message );
		}
