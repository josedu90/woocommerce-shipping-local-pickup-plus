...
class WC_Local_Pickup_Plus_Schedule_Adjustment {
	...
	public function get_relative_date( $date = null, $format = 'mysql', $timezone = 'UTC' ) {
		_deprecated_function( 'WC_Local_Pickup_Plus_Schedule_Adjustment::get_relative_date()', '2.3.5' );
		return $date;
	}
	...
	public function get_relative_time( $date = null, $timezone = 'UTC' ) {
		_deprecated_function( 'WC_Local_Pickup_Plus_Schedule_Adjustment::get_relative_time()', '2.3.5' );
		return $date;
	}
